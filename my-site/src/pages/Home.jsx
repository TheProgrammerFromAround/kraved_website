  ...
  return (
    <>
        ...
        <div className="block2">
            ...
            <button className="orderbutton" id='orderbutton1' onClick={() => handleButtonClick("/shop")}>Order Now</button>
        </div>
        ...
        <div className="block3">
            ...
            <button className="orderbutton" id='orderbutton2' onClick={() => handleButtonClick("/shop")}>Order Now</button>
        </div>
